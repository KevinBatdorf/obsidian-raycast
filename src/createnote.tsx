  ...
  function NoteForm(props: { vaultPath:string }) {
    ...
    function createNewNote(noteProps: FormValue) {
        if (noteProps.name == ""){
            ...
            try {
                console.log(path.join(vaultPath, noteProps.path, noteProps.name + ".md"));
    ...
    return (
      ...
      >
        <Form.TextField title="Name" id="name" />
        <Form.TextField title="Path" id="path" defaultValue={prefPath()}/>
